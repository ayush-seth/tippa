...
export const ecosystem: EcosystemProduct[] = [
  {
    slug: "tippasplit",
    name: "TippaSplit",
    tagline: "The national debt management platform.",
    description:
  ...
  },
  {
    slug: "tippabnb",
    name: "TippaBnB",
    tagline: "Official housing marketplace for citizens.",
    description:
  ...
  {
    slug: "marketplace",
    name: "Tippa Marketplace",
    tagline: "Buy, sell and trade goods.",
    description:
  ...
  {
    slug: "codenames",
    name: "Tippa Codenames",
    tagline: "The People's official party word game.",
    description:
  ...
  },
  {
    slug: "merch",
    name: "Tippa Merch",
    tagline: "Official national merchandise platform.",
    description:
  ...
  },
  {
    slug: "league",
    name: "Tippa League",
    tagline: "Official sports and competition ecosystem.",
    description:
  ...
  },
  {
    slug: "archives",
    name: "Tippa Archives",
    tagline: "The Library of Alexandria for Tippa.",
    description:
  ...
  },
  {
    slug: "live",
    name: "Tippa Live",
    tagline: "24-hour national news network.",
    description:
